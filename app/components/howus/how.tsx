    ...
    <div className="container px-5 py-24 mx-auto capitalize"><div className="text-center mb-20">
      ...
      <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
        ...
        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
          <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Motivation</h2>
          <p className="leading-relaxed text-base">Gamification can incentivize and motivate users to make more sustainable travel choices, leading to behavioral changes that can have a significant impact on the environment.
</p>
      ...
      <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
          <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Engagement</h2>
          <p className="leading-relaxed text-base">Gamification can also engage users by providing challenges, leaderboards, and rewards, incentivizing sustainable trips.

...
export default function Process() {
  return (
    <div
      className="bg-green-50 text-gray-600 body-font capitalize"
      id="howitworks">
          ...
          <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  You Browse the App and Feed Your Destination
                </p>
              </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Next, You will have options to choose your eco-friendly means
                  to transport along with the points associated
                </p>
              </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  Voila! You can now book your trip and get your points added
                  once trip is done
                </p>
              </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  You can Spend your rewards in Rewards Section
                </p>
              </div>
            </div>
            <div className="flex relative">
              ...
              <div className="flex-grow pl-4">
                ...
                <p className="leading-relaxed">
                  You can also check your personal leaderboard with your friends
                </p>
              </div>
            </div>
          </div>

export default function Hero() {
    return (  <div className="relative px-4 pt-16 mx-auto lg:py-32 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full capitalize">
    <div className="max-w-xl mx-auto lg:max-w-screen-xl">
      <div className="mb-16 lg:max-w-lg lg:mb-0">
        <div className="max-w-xl mb-6">
          ...
          Get Rewarded While You a fellow Earthling contribute by switching to a eco-friendly transporation!
          </p>
        </div>
    ...
    <div className="flex justify-center h-full overflow-hidden lg:w-2/3 xl:w-1/2 lg:absolute lg:justify-start lg:bottom-0 lg:right-0 lg:items-end">
      <img
        src="https://cdn.dribbble.com/users/331579/screenshots/3193478/mission_pic_badges_drib.jpg"

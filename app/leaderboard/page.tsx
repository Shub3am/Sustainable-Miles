...
export default function LeaderBoard() {
    ...
    useEffect(()=> {
        fetch("/api/leaderboard").then(data=> data.json()).then(datas=> {
            console.log(datas)
            const le = datas.map(single => {
                ...
                <td className="p-2 whitespace-nowrap">
                    <div className="text-left font-medium text-green-500">{single.points}</div>
                </td>
    ...
    , [])
       ...
       return (<section className="antialiased mt-20 text-gray-600 px-4">
